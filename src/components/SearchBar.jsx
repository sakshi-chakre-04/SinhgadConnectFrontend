  ...
  return (
    <div className={className} ref={wrapperRef}>
      <form onSubmit={handleSubmit} className="relative group">
        {/* Gradient border wrapper - matching Ask AI button style */}
        <div className="relative p-[1.5px] rounded-xl bg-gradient-to-r from-violet-500/50 via-fuchsia-500/50 to-indigo-500/50 shadow-[0_0_12px_rgba(139,92,246,0.15)] group-focus-within:shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all duration-300">
          <div className="relative flex items-center bg-white/95 rounded-[10px]">
            ...
            <input
              ...
              className="block w-full pl-10 pr-4 py-2.5 border-0 rounded-[10px] bg-transparent text-gray-700 placeholder-gray-500 focus:outline-none transition-all duration-300 ease-out"
