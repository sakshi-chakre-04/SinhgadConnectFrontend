  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative p-2 text-gray-500 hover:text-indigo-600 hover:bg-indigo-50/80 rounded-xl focus:outline-none transition-all duration-200 hover:scale-105 active:scale-95"
      >
