...
const Sidebar = ({ onCreatePost }) => {
    ...
    return (
        <nav className="hidden lg:flex flex-col fixed left-4 top-[72px] bottom-4 w-[244px] glass-panel rounded-[2rem] p-5 z-30 transition-all duration-300 border border-white/60 shadow-2xl shadow-indigo-500/10">
            {/* Navigation Items */}
