...
const RightSidebar = () => {
    ...
    return (
        <aside className="hidden xl:flex flex-col fixed right-4 top-[72px] bottom-4 w-[280px] glass-panel rounded-[2rem] p-4 z-30 transition-all duration-300 border border-white/60 shadow-2xl shadow-indigo-500/10 overflow-y-auto scrollbar-thin scrollbar-thumb-violet-500/30 scrollbar-track-transparent">
